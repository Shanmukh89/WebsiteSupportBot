...
export default function Dashboard() {
    useEffect(() => {
        document.title = 'Dashboard | Ragify';
    }, []);
    ...
    return (
        <div className="dt-dash-layout">
            ...
            <aside className="dt-dash-sidebar">
                <div className="dt-dash-logo">Ragify</div>
                ...
                <div className="dt-dash-user-section" style={{ position: 'relative' }}>
                    <AnimatePresence>
                        {isProfileMenuOpen && (
                            ...
                            >
                                <button className="dt-dash-profile-menu-item" onClick={() => router.push('/settings')}>
                                    <User size={16} /> Account Settings
                                </button>
                                <button className="dt-dash-profile-menu-item custom-hover-red" onClick={() => router.push('/')}>
